...
public class SeleniumOperations {
	...
	public static void open_chrome_and_close() {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\\\Nephat\\Desktop\\chromedriver-win64\\chromedriver.exe");
		...
		//driver.close();
                ...
                System.out.println("Exception encounter " + e);
            }
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from s225504843:, Nephat Komu Muriithi");
		...
		// write code
                ...
                System.out.println("Window set to 640 by 480");
                sleep(2);
		...
		System.out.println("2. change window size to 1280 by 960");
		// Sleep a while
		sleep(2);
